...
====lancer les deux VMs, avec et sans VDE2====
    ...
    - Si le fichier est dÃ©jÃ  sollicitÃ© par la 1Ã¨re VM on ne peut pas l'utiliser pour la seconde car Ã§a crÃ©erait des conflits et rendrait la VM inutilisable.

====DiffÃ©rences paramÃ¨tres IP====
  Sur chaque VM:
...
===Protocole rÃ©seau graphique : X Window===

 - DÃ©marrage du serveur X avec la commande: <code>startx</code>
 ...
 - Afficher les informations des Ã©crans connectÃ©s avec la commande: <code>xrandr</code>

 - Affichez les informations de la fenÃªtre d'un terminal xterm avec la commande: <code>xwinfo</code>   puis cliquer sur la fenÃªtre choisie

 - Basculer entre affichage non graphique et graphique sans arrÃªter le serveur X avec les touches: Ctrl+alt+F2/3/4/5

===Modification de rÃ©seau===
